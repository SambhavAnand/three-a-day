...
export const addDonation = (first_name,last_name, email,donator_type, address_field, pin_code, phone_number, no_meals, people_per_meal, restaurant_name) => {
...
export const addCharityRequest = (first_name, last_name, charity_email, charity_name, address_field, pin_code, phone_number, no_orders) => {
  return new Promise((resolve, reject) => {
    let today = new Date();
    let node;
    let hrs = today.getHours();
