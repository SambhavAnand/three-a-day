...
export default class Home extends React.Component {
  ...
  render() {
    return (
      ...
      {
        !this.state.donor && !this.state.receive &&
            <div className="prompt">
                  ...
                  <div className="buttons">
                      <h1>Make a change</h1>
                      <RaisedButton label="Donate" primary={true}  onClick={()=>this._handleFormRender("donor")}/>
                      <RaisedButton label="Receive" primary={true} onClick={()=>this._handleFormRender("receive")}/>
                  </div>
            </div>
          }
          {
